package me.MiniDigger.ElytraRace.config;
...
public class SimpleConfig {
	...
	protected boolean isPrimitiveWrapper(Object input) {
		...
		return input instanceof Integer || input instanceof Boolean || input instanceof Character || input instanceof Byte || input instanceof Short
