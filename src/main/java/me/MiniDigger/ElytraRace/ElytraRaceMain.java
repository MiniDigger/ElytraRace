        ...
        for (ElytraRace race : races) {
            for (ElytraRacePortal p : race.getPortals()) {
                for (Location l : p.getLocations()) {
                    if (l.getWorld().getName().equals(loc.getWorld().getName()) && ElytraRaceUtil.almostEqual(loc.getX(), l.getX(), 1) && ElytraRaceUtil.almostEqual(loc.getY(), l.getY(), 1)
                            && ElytraRaceUtil.almostEqual(loc.getZ(), l.getZ(), 1)) {
                        return p;
                    }
                }
            }
